...
**The most recent version of the spMC package can be downloaded from [here](https://cran.r-project.org/web/packages/spMC/index.html), and its source code can be found [here](https://github.com/cran/spMC).**
